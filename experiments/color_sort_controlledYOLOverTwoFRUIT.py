...
Structure:
    ...
    - FRUIT_SCAN_HOME     — servo positions for horizontal fruit- pose
...
class ControlledColorSort(Node):
    ...
    def classify_fruit(self, rgb_image):
        ...
        results = self.fruit_model(rgb_image, verbose=False, conf=0.65)
